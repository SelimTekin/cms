...
class Courses extends CI_Controller{ # CI -> CodeIgniter (extend etmemizin sebebi bu class'ı CodeIgniter'ın bir controller olarak görmesi gerekiyor.)
    ...
    public function update($id){
        ...
        if($validate){
            ...
            else{ # Kullanıcı resmi değiştirmek istemeyebilir bu else o yüzden var
    ...
    public function isActiveSetter($id){
        ...
        if($id){
            ...
            $this->course_model->update( # update 2 tane parametre alır where,data
                array(
                    "id"    => $id,
                ),
