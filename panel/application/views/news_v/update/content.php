    ...
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-body">
                <form action="<?php echo base_url("news/update/$item->id"); ?>" method="post" enctype="multipart/form-data"> <!--Eğer formda bir dosya göndermek istiyorsak enctype="multipart/data" dememiz lazım ki $_FILES isimli değişkeni(News.php controller'ında) doldurabilsin yoksa boş array döner-->
