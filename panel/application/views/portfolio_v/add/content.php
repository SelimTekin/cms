                ...
                <form action="<?php echo base_url("portfolio/save"); ?>" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="hidden" name="finishedAt" id="datetimepicker1" data-plugin="datetimepicker" data-options="{ inline: true, viewMode: 'days', format: 'YYYY-MM-DD HH:mm:ss'}"> <!--format'ı biz yazdık çünkü saat dakika sniye şeklinnde görünsün diye (Yoksa AM PM şeklinde görünüyordu)-->
                        </div>
                    ...
                    <a href="<?php echo base_url("portfolio"); ?>" class="btn btn-danger btn-outline">İptal</a>
                </form>
            </div><!-- .widget-body -->
        </div>
	</div>
