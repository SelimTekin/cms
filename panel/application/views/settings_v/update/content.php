<div class="row">
    ...
    <div class="col-md-12">
        <form action="<?php echo base_url("settings/update/$item->id"); ?>" method="post" enctype="multipart/form-data"><!-- dosya gönderdiğimiz için enctype="multipart/form-data" yapalım ki o bilgiyi alabilelim-->
            <div class="widget">
                        ...
                        <div role="tabpanel" class="tab-pane in active fade" id="tab-1">
                            ...
                            <div class="row">
                                <div class="form-group col-md-8">
                                    ...
                                    <input class="form-control" placeholder="Şirketinizin ya da Sitenizin adı" name="company_name" value="<?php echo isset($form_error) ? set_value("company_name") : $item->company_name; ?>">
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    <label>Fax 1</label>
                                    <input class="form-control" placeholder="Fax numaranız" name="fax_1" value="<?php echo isset($form_error) ? set_value("phone_2") : $item->phone_2; ?>">
                                </div>

                                <div class="form-group col-md-4">
                                    <label>Fax 2</label>
                                    <input class="form-control" placeholder="Diğer fax numaranız (opsiyonel)" name="fax_2" value="<?php echo isset($form_error) ? set_value("phone_2") : $item->phone_2; ?>">
                                </div>
                            </div>
