                            ...
                            <?php foreach($items as $item){ ?>
                                <tr>
                                    ...
                                    <td class="text-center w300">
                                        ...
                                        <a href="<?php echo base_url("users/update_password_form/$item->id"); # id'yi parametre olarak verdik ?>" class="btn btn-sm btn-purple btn-outline"><i class="fa fa-key"></i> Şifre Değiştir</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
